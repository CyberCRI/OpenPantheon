  ...
  <section class="section container">
    <div class="box columns is-multiline">
      <div class="section column is-3">
        <figure v-if="data.claims && data.claims.P18" class="image is-1by1 is-rounded">
          <img
      ...
      <div class="section column is-3">
        <h1 v-if="data.labels" class="title">{{ data.labels[$i18n.locale].value }}</h1>
        ...
        <div class="buttons">
          <b-navbar-item
            ...
            v-if="!isLoading"
            ><strong class="is-size-6 mx-6">Celebrate</strong></b-navbar-item
          >
        </div>
      </div>

      <div class="section column is-3"></div>
      <div class="section column is-3"></div>
      <div id="bio" class="section column is-6">
      ...
      <div id="factsheet" class="section column is-6">
      ...
      <b-skeleton size="is-medium" :active="isLoadingProperties"></b-skeleton>
      <hr />
      <div class="section column is-6" v-for="comment in personality.comments">
        {{ comment.text }}
      </div>
